...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    styleChevron: ViewPropTypes.style
  };
  ...
  static defaultProps = {
    ...
    styleChevron: {color: colorPack.primary},
    styleEmptyListText: {color: colorPack.danger}
  };
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Text
            style={[
              ...
              fontFamily ? { fontFamily } : {},
              styleEmptyListText ? {styleEmptyListText} : {}
            ]}
          >
            No item to display.
          </Text>
                ...
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Icon
                      ...
                      style={[styles.indicator, styleChevron]}
                    />
                  </View>
                </TouchableWithoutFeedback>
              </View>
